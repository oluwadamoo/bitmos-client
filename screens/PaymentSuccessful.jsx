...
const SuccessScreen = ({ route, navigation, setOpenDetails }) => {
  ...
  console.log(payWithCard, "carddd");
  console.log(payWithWallet, "walletttt");
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={styles.wrapper}>
            <View style={styles.top}>
              ...
              >
                {paymentSuccessful ? "Payment Successful" : "Your order was successful"}
              </Text>
            </View>
            ...
            <View style={styles.footer}>
              <Pressable
                onPress={paymentSuccessful ? closeScreen : proceedToPayment}
                style={({ pressed }) => [
                  {
                    opacity: pressed ? 0.5 : 1,
              ...
              >
                ...
                >
                  {paymentSuccessful ? "Continue" : "Proceed to payment"}
                </Text>
              </Pressable>
            </View>
          </View>
